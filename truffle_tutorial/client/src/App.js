...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      //this.itemManager.options.address = "0x7f2Fb0dD88deD6F166cc8DB076427a05AD9666D1";

      //instance.options.address = "0x7f2Fb0dD88deD6F166cc8DB076427a05AD9666D1";
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Account: {this.accounts.address}</h2>
        <h2>Items</h2>
        <h2>Add Items</h2>
